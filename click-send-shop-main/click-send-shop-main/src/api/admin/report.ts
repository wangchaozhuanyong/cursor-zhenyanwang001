...
export function getProfitMonthly(params?: ReportQuery) {
  return get<Record<string, unknown>>("/admin/reports/profit/monthly", params as unknown as Record<string, unknown>);
}
