...
export default function SegmentedDateInput({
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        className={`admin-segmented-control flex min-h-[44px] w-full items-center gap-1 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-surface)] px-3 py-2 text-sm text-foreground ${controlClassName}`}
