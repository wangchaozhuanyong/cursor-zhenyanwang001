...
export const ADMIN_ROUTE_TITLE_RULES: AdminRouteTitleRule[] = [
  ...
  { test: (p) => p.startsWith("/admin/user-favorites"), titleKey: "routeTitles.users" },
  { test: (p) => p.startsWith("/admin/user-history"), titleKey: "routeTitles.users" },
  { test: (p) => p.startsWith("/admin/privacy-requests"), titleKey: "routeTitles.auditLogs" },
  ...
  { test: (p) => p.startsWith("/admin/myinvois"), titleKey: "routeTitles.payments" },
];
...
export const ADMIN_ROUTE_ACCESS_RULES: AdminRouteAccessRule[] = [
  ...
  { test: (p) => p.startsWith("/admin/user-favorites"), rule: one("user.view") },
  { test: (p) => p.startsWith("/admin/user-history"), rule: one("user.view") },
  { test: (p) => p.startsWith("/admin/privacy-requests"), rule: one("audit.view") },
  ...
  { test: (p) => p.startsWith("/admin/myinvois"), rule: one("myinvois.manage") },
