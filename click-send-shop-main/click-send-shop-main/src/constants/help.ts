...
export const FAQS: FaqItem[] = [
  {
    id: "platform-1",
    category: "平台介绍",
    question: "大马通主要提供什么服务？",
    answer: "大马通面向马来西亚华人用户，提供签证咨询、留学申请、第二家园、商业装修、本地生活服务与合规精选好物信息。不同服务的办理条件、周期、费用和适用范围，需要根据实际情况由客服确认。",
  },
  {
    id: "platform-2",
    category: "平台介绍",
    question: "大马通是购物网站还是服务平台？",
    answer: "大马通是本地生活服务与精选好物结合的平台。部分内容属于服务咨询，部分内容属于商品信息展示。具体服务范围、商品状态、费用和后续流程，以页面说明和客服确认为准。",
  },
  {
    id: "platform-3",
    category: "平台介绍",
...
export const WORKING_HOURS = "每天 09:00 - 22:00";
