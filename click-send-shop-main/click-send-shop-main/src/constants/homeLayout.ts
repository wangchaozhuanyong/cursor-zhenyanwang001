...
export const HOME_GUEST_MAIN_CLASS =
  "mx-auto flex w-full max-w-screen-xl flex-col gap-3 px-[var(--store-page-x)] pt-[var(--store-page-y)] pb-4 sm:gap-5 md:gap-6 md:px-6 md:pb-5 lg:gap-8 lg:px-8 lg:pb-8";
