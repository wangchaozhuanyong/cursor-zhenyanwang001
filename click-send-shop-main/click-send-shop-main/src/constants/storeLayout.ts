...
export const STORE_MOBILE_PAGE_HEADER_CLASS = "store-mobile-page-header md:hidden";
...
export const STORE_AUTH_SHELL_CLASS =
  "auth-page-shell sf-next-page store-v12-page auth-v12-page fixed inset-0 z-[80] flex flex-col overflow-hidden bg-[var(--theme-bg)] lg:static lg:min-h-[100dvh] lg:justify-center lg:bg-[color-mix(in_srgb,var(--theme-bg)_94%,var(--theme-surface))]";
