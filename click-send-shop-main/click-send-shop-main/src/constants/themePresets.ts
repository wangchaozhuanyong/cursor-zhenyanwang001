...
export const POLAR_SKIN_ID = "polar";
export const MOSS_SKIN_ID = "moss";
...
export const DEFAULT_SKIN_ID = POLAR_SKIN_ID;
export const DEFAULT_HOLIDAY_SKIN_ID = NEWYEAR_SKIN_ID;
...
export const MOSS_CONFIG: ThemeConfig = {
  skinName: "雾苔栖居·自然生活",
  bgColor: "#EEF1E8",
  surfaceColor: "#FFFDF6",
  primaryColor: "#405C43",
...
export const IRIS_CONFIG: ThemeConfig = {
  skinName: "鸢尾镜廊·时装美妆",
  bgColor: "#F4EFF7",
  surfaceColor: "#FFFDFE",
  primaryColor: "#5D4778",
...
export const NEWYEAR_CONFIG: ThemeConfig = {
  skinName: "瑞锦新岁·春节臻礼",
  bgColor: "#FFF3EA",
  surfaceColor: "#FFFDF8",
  primaryColor: "#B91F2C",
...
export const MIDAUTUMN_CONFIG: ThemeConfig = {
  skinName: "桂月云璧·中秋臻礼",
  bgColor: "#F4F0E6",
  surfaceColor: "#FFFDF7",
  primaryColor: "#243C63",
...
export const POLAR_SKIN: ThemeSkin = {
  id: POLAR_SKIN_ID,
...
export const IRIS_SKIN: ThemeSkin = {
  id: IRIS_SKIN_ID,
...
export const NEWYEAR_SKIN: ThemeSkin = {
  id: NEWYEAR_SKIN_ID,
...
export const MIDAUTUMN_SKIN: ThemeSkin = {
...
export const DAILY_COMMERCE_SKIN = POLAR_SKIN;
export const FESTIVAL_RUBY_GOLD_SKIN = NEWYEAR_SKIN;
