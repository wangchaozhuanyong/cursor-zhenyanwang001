...
export const navItemsRaw: NavItem[] = [
  ...
  },
  {
    ...
    path: "/admin/users",
    permission: { anyOf: ["user.view", "member_level.manage", "review.view", "review.manage", "event.view", "event.manage", "audit.view"] },
    children: [
      ...
      { icon: Star, label: "收藏管理", path: "/admin/user-favorites", permission: "user.view" },
      { icon: MousePointerClick, label: "浏览历史", path: "/admin/user-history", permission: "user.view" },
      { icon: Shield, label: "隐私请求", path: "/admin/privacy-requests", permission: "audit.view" },
      { icon: MessageSquareMore, labelKey: "nav.feedback", path: "/admin/feedback", permission: "user.view" },
  ...
  },
  {
    ...
    children: [
      ...
      { icon: Ticket, label: "优惠券模板", path: "/admin/marketing/coupons", permission: "coupon.view", capability: "couponEnabled" },
      { icon: Megaphone, label: "领券活动", path: "/admin/marketing/coupon-campaigns", permission: "coupon.view", capability: "couponEnabled" },
  ...
  },
  {
    ...
    children: [
      ...
      { icon: FileText, label: "MyInvois 电子发票", path: "/admin/myinvois", permission: "myinvois.manage" },
