...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "defaultOgImageUrl", label: "默认 OG 图（1200×630）", type: "image", hint: "未设置单页 OG 图时使用默认图，不要使用 favicon 小图。" },
      { key: "googleSiteVerification", label: "Google Site Verification", placeholder: "google-site-verification token" },
      { key: "complianceNotice", label: "全站默认合规说明", type: "textarea", rows: 2, placeholder: "用于受监管商品或服务的统一合规提示文案。" },
      {
        key: "ageGateEnabled",
        label: "启用年龄提示",
        type: "select",
      ...
      {
        key: "restrictedProductNoindexEnabled",
        label: "受监管商品默认 noindex",
        type: "select",
        options: [
          { value: "1", label: "开启" },
          { value: "0", label: "关闭" },
