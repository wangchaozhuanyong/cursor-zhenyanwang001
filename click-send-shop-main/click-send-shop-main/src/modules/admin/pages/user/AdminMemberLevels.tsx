  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <LoadingButton type="button" variant="outline" state="normal" onClick={async () => { try { const r = await userService.recalculateAllMemberLevels(); toast.success(`重算完成：${r?.changed || 0}/${r?.total || 0}`); } catch (e) { toast.error(toastErrorMessage(e, "重算失败")); } }}>全量重算会员等级</LoadingButton>
      </div>
