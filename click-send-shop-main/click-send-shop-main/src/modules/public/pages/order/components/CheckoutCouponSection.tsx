  ...
  return (
    <div className={SECTION_SHELL}>
      <div className="mb-3 flex items-center gap-3">
        <span className="store-checkout-step flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[var(--theme-price)] text-xs font-bold text-white">3</span>
        <div>
