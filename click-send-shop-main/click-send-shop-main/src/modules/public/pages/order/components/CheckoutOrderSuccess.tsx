...
const CHECKOUT_SUCCESS_COPY: Record<PublicLocale, {
  ...
  ms: {
    ...
    headerPaid: "Bayaran berjaya",
    headerFinishPayment: "Lengkapkan bayaran",
    headerPendingPayment: "Menunggu bayaran",
    headerSubmitted: "Pesanan dihantar",
    headerOnlineUnavailable: "Bayaran dalam talian tidak tersedia",
    headerWalletInsufficient: "Baki dompet tidak mencukupi",
    headingPaid: "Bayaran berjaya",
    headingFinishPayment: "Lengkapkan bayaran",
    headingSubmitted: "Pesanan dihantar",
    paidHelper: "Bayaran selesai. Kami akan mengatur penghantaran secepat mungkin. Anda boleh jejaki kemajuan dalam Pesanan Saya.",
    onlinePendingHelper: "Bayaran telah dimulakan melalui saluran yang dipilih semasa checkout. Jika tidak dialihkan, teruskan atau cuba semula di bawah. Anda juga boleh bayar dari butiran pesanan.",
    onlineUnavailable: "Bayaran dalam talian belum diaktifkan. Sila hubungi sokongan.",
    walletInsufficientWithOnline: (error) => `${error} Gunakan bayaran dalam talian atau hubungi sokongan.`,
    walletInsufficientNoOnline: (error) => `${error} Bayaran dalam talian belum diaktifkan. Sila hubungi sokongan.`,
    walletPendingWithOnline: (balance) => `Dompet ganjaran tersedia: RM ${balance.toFixed(2)}. Lengkapkan bayaran dompet di bawah atau tukar kepada bayaran dalam talian.`,
    walletPendingNoOnline: (balance) => `Dompet ganjaran tersedia: RM ${balance.toFixed(2)}. Lengkapkan bayaran dompet di bawah atau hubungi sokongan.`,
    whatsappPendingWithOnline: "Hantar butiran pesanan kepada sokongan. Untuk bayaran dalam talian atau dompet, buka Lagi cara.",
    whatsappPendingNoOnline: "Hantar butiran pesanan kepada sokongan. Untuk bayaran dompet, buka Lagi cara.",
    pendingHelper: "Pesanan ini menunggu bayaran. Anda boleh teruskan dari butiran pesanan.",
    thanks: "Terima kasih atas pesanan anda.",
    paidBadge: "Dibayar",
    pendingBadge: "Perlu bayar",
    processingBadge: "Diproses",
    order: "Pesanan",
    keyInfo: "Maklumat penting",
    paymentMethod: "Kaedah bayaran",
    methodOnline: "Bayaran dalam talian",
    methodWallet: "Dompet ganjaran",
    amountDue: "Jumlah perlu dibayar",
    orderTime: "Masa pesanan",
    nextActions: "Tindakan seterusnya",
    repay: "Cuba bayar semula",
    continuePay: "Teruskan bayaran",
    continueInDetail: "Teruskan bayaran dalam butiran pesanan",
    viewOrderDetail: "Lihat butiran pesanan",
    changePayment: "Tukar kaedah bayaran",
    alternatePaymentWarning: "Ini ialah kaedah bayaran alternatif. Gunakan dengan berhati-hati jika berbeza daripada checkout.",
    paying: "Sedang bayar...",
    tryWallet: (balance) => `Cuba dompet ganjaran (tersedia RM ${balance.toFixed(2)})`,
    useWallet: (balance) => `Bayar dengan dompet ganjaran (tersedia RM ${balance.toFixed(2)})`,
    switchOnline: "Guna bayaran dalam talian",
    sendWhatsapp: "Hantar ke WhatsApp",
    sendWechat: "Hantar ke WeChat",
    copyOrder: "Salin butiran pesanan",
    moreWays: "Lagi cara",
    onlinePayment: "Bayaran dalam talian",
    walletOption: (balance) => `Dompet ganjaran (tersedia RM ${balance.toFixed(2)})`,
    orderDetails: "Butiran pesanan",
    goodsTotal: "Jumlah barang",
    goodsTotalTaxIncluded: "Jumlah barang (termasuk cukai)",
    shipping: "Penghantaran",
    standardShipping: "Standard",
    taxExcludedShipping: ", tidak dikenakan cukai",
