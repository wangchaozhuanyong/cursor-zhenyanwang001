      ...
      <div className="divide-y divide-[var(--theme-border)] rounded-2xl bg-[var(--theme-bg)] px-4">
        ...
        <label className="block py-3.5">
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-[var(--theme-border)] bg-[var(--theme-surface)] px-3 py-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground focus:ring-2 focus:ring-[var(--theme-primary)]"
          />
        </label>
      </div>
