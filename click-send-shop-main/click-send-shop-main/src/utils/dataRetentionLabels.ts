...
export const DATA_CLEANUP_POLICY_LABELS: Record<string, string> = {
  uploaded_assets_orphaned_files: "未引用上传文件",
  ...
  admin_webauthn_credentials_revoked: "已撤销管理员通行密钥",
  cart_items: "购物车明细",
  checkout_abandonments: "未完成结账快照",
  browsing_history: "浏览历史",
  user_feedback_closed: "已处理用户反馈",
  ...
  export_tasks: "导出任务记录",
  export_files: "导出文件",
  uploaded_assets_soft_deleted: "已软删除上传资产元数据",
  user_login_audits: "用户登录审计",
  user_security_events_resolved: "已解决用户安全事件",
  user_risk_ips_released: "已解除风险 IP",
  user_risk_devices_released: "已解除风险设备",
  audit_logs: "审计日志",
  admin_event_records_resolved: "已解决后台事件",
  backup_alerts_resolved: "已解决备份告警",
  backup_jobs_terminal_without_files: "无备份文件的终态备份任务",
  restore_drill_reports_finished: "已完成恢复演练报告",
  data_cleanup_run_steps_history: "数据清理步骤历史",
  data_cleanup_runs_history: "数据清理运行历史",
  data_cleanup_locks_expired: "过期数据清理锁",
...
export const DATA_CLEANUP_TABLE_LABELS: Record<string, string> = {
  ...
  admin_trusted_devices: "管理员可信设备",
  admin_sensitive_action_tokens: "敏感操作令牌",
  admin_webauthn_credentials: "管理员通行密钥",
  cart_items: "购物车明细",
  checkout_abandonments: "未完成结账快照",
  browsing_history: "浏览历史",
  user_feedback: "用户反馈",
  ...
  export_tasks: "导出任务记录",
  export_files: "导出文件目录",
  uploaded_assets: "上传资产元数据",
  user_login_audits: "用户登录审计",
  user_security_events: "用户安全事件",
  user_risk_ips: "风险 IP",
  user_risk_devices: "风险设备",
  audit_logs: "审计日志",
  admin_event_records: "后台事件记录",
  backup_alerts: "备份告警",
  backup_jobs: "备份任务",
  restore_drill_reports: "恢复演练报告",
  data_cleanup_run_steps: "数据清理步骤",
  data_cleanup_runs: "数据清理运行",
  data_cleanup_locks: "数据清理锁",
  data_consistency_runs: "一致性检测运行记录",
  data_consistency_rule_events: "一致性规则事件",
  data_change_events: "数据变更事件",
