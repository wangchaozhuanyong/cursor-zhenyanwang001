...
router.post('/anomalies/:id/rescan', canManage, highCostApiLimiter, controller.rescanAnomaly);
...
router.post('/repair-tasks/:id/execute', requirePermission('monitoring.repair'), highCostApiLimiter, controller.executeRepairTask);
...
router.post('/rules/:code/run', canManage, highCostApiLimiter, controller.runRule);
