...
function formatOrderItem(row) {
  ...
  return {
    ...
    original_qty: row.original_qty == null ? null : Number(row.original_qty),
...
function formatOrder(row, items, returnMeta = null) {
  ...
  return {
    ...
    goods_original_amount: Number(row.goods_original_amount ?? row.raw_amount ?? 0),
    goods_sale_amount: Number(row.goods_sale_amount ?? row.raw_amount ?? 0),
    goods_net_sales_amount: Number(row.goods_net_sales_amount || 0),
    activity_discount_amount: Number(row.activity_discount_amount || 0),
    coupon_discount_amount: Number(row.coupon_discount_amount || 0),
    shipping_original_fee: Number(row.shipping_original_fee ?? row.shipping_fee ?? 0),
    shipping_discount_amount: Number(row.shipping_discount_amount || 0),
    total_discount_amount: Number(row.total_discount_amount || 0),
    payable_amount: Number(row.payable_amount ?? row.total_amount ?? 0),
    paid_amount: Number(row.paid_amount || 0),
    net_received_amount: Number(row.net_received_amount || 0),
    outstanding_amount: Number(row.outstanding_amount || 0),
    amount_snapshot: parseJsonObject(row.amount_snapshot),
