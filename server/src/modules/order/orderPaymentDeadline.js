/**
 * 未支付订单付款截止时间：与 orderPaymentTimeout.service 共用配置。
 */
const { ORDER_STATUS, PAYMENT_STATUS } = require('../../constants/status');
const { loadPaymentTimeoutSettings } = require('./orderPaymentTimeout.service');
...
function isPendingOnlineUnpaid(order) {
  ...
  return (order.payment_method || 'whatsapp') === 'online';
}
