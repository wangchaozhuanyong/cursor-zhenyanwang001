...
async function insertOrder(q, params) {
  const {
    ...
    goodsCostAmount, goodsNetSalesAmount, grossProfitAmount, shippingCostAmount, paymentFeeAmount, netProfitAmount,
  } = params;
  await q.query(
    `INSERT INTO orders
...
async function insertOrderItem(q, params) {
  ...
  await q.query(
    ...
    [
      ...
      Number(netSalesAmount || 0),
      Number(grossProfitAmount || 0),
      costSnapshotSource || 'missing',
      points,
