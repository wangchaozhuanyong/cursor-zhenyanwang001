...
const OBSIDIAN_BLACK_GOLD_CONFIG = {
  skinName: '曜石黑金',
  radius: '8px',
  fontFamily: 'inter',
  bgColor: '#050505',
...
const OBSIDIAN_BLACK_GOLD_SKIN = {
...
const MIDNIGHT_TITANIUM_CONFIG = {
  skinName: '幻夜钛银',
  radius: '16px',
  fontFamily: 'space',
  bgColor: '#0F141E',
...
const FESTIVE_RUBY_GOLD_CONFIG = {
  skinName: '瑞红鎏金',
  radius: '12px',
  fontFamily: 'inter',
  bgColor: '#FDFBF7',
...
const ORGANIC_SANDSTONE_CONFIG = {
  skinName: '质朴砂岩',
  radius: '12px',
  fontFamily: 'fraunces',
  bgColor: '#F5F2EB',
